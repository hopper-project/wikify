"""Contains commonly used functions/regex from the hoptex repo"""

 # """Taken wholesale from the hoptex repo, should be kept up to date with
 # the latest version from there. This is in this repo primarily to enable
 # bibdoc_wikifier to remove all LaTeX from a document"""
